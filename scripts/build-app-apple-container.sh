...
image=certarium-app:linux-amd64
cid=certarium-export-$$
...
container cp "$cid:/certarium" "$project_dir/dist/certarium-linux-amd64"
chmod 0755 "$project_dir/dist/certarium-linux-amd64"
shasum -a 256 "$project_dir/dist/certarium-linux-amd64" > "$project_dir/dist/certarium-linux-amd64.sha256"
